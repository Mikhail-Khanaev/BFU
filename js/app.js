    ...
    let Pe = {
      ...
      2: {
        bottomWeek: {
          ...
          2: {
            1: "Теория автоматов и трансляторов (практика), 230а",
            2: "Основы программирования (практика), 214",
            3: "Основы программирования (практика), 214",
            4: "Комплексный анализ (лекции), 215",
            5: ",",
            6: ",",
            7: ",",
          },
      ...
      3: {
        bottomWeek: {
          1: {
            ...
            2: ",",
            3: "Основы программирования (практика), 214",
            4: "Основы программирования (практика), 214",
            5: ",",
            6: "Физкультура, ФОК",
            7: ",",
          },
          2: {
            1: ",",
            2: ",",
            3: "Теория автоматов и трансляторов (практика), 230а",
            4: "Комплексный анализ (лекции), 215",
            5: "АСД (практика), 230а",
            6: ",",
            7: ",",
          ...
          3: {
            1: ",",
            2: ",",
            3: "Дискретная математика (практика), 230а",
            4: "Математический анализ (практика), 205",
